...
# entangling_dropout documentation build
...
from entangling_dropout import __version__ as release

# -- Project information -----------------------------------------------------

project = "entangling_dropout"
author = "Kedro"
...
htmlhelp_basename = "entangling_dropoutdoc"
...
latex_documents = [
    (
        master_doc,
        "entangling_dropout.tex",
        "entangling_dropout Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "entangling_dropout",
        "Project entangling_dropout codebase.",
        "Data-Science",
    )
]
